...
> **Erledigt:** dedizierte Formspree-Form-ID `xppznnwr` angelegt. Sie steht zentral in `src/_data/site.js` (`site.formspree`); beide Formulare referenzieren sie über `{{ site.formspree }}`, keine Form-ID im Markup.
